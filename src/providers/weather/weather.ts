...
export class WeatherProvider {
  apiKey = '0IlLrwIGUTdiq9GFuqsQWbPGCGGGpZdK';
  lang = 'th-th';
  ...
  getWeather(location: WeatherLocation) {
    ...
    //     '&details=true&getphotos=true';
        this.url = 'http://dataservice.accuweather.com/currentconditions/v1/321549?apikey=0IlLrwIGUTdiq9GFuqsQWbPGCGGGpZdK&language=th-th&details=true';
